...
from app.modules.meter_readings.batch_router import router as meter_reading_batches_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(meter_reading_batches_router, tags=["meter_reading_batches"])
